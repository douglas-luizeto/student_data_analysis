...
🇧🇷 Resumo Executivo em Português | 🇺🇸 Executive Summary in English
...
The Silver Bullet (Distance to Advanced): 75% of bad churn in Math occurs in students who are more than 2.5 stages behind their school grade level.
...
Window Functions: Used to calculate months_enrolled, avg_sheets_3 (lagged averages), and cv_3.
...
Month 4 Intervention: Mandatory feedback session to address the "Critical Leakage" period.
